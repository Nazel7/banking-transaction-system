...
public class UserMapper {
    ...
    public static UserModel mapToModel(SignUpDto signUpDto){
        ...
        return UserModel
                ...
                .verifiedHomeAddress(signUpDto.getVerifiedHomeAddress() != null ? signUpDto.getVerifiedHomeAddress(): null)
                .verifiedBvn(signUpDto.getVerifiedBvn() != null ? signUpDto.getVerifiedBvn(): null)
                .verifiedEmail(signUpDto.getEmail() != null ? signUpDto.getVerifiedEmail(): null)
                .verificationCode(signUpDto.getVerificationCode())
                .verifiedPhone(signUpDto.getVerifiedPhone() != null ? signUpDto.getVerifiedPhone(): null)
